...
export default function AdminCategory() {
    ...
    return (
        <div className="overflow-y-scroll w-full h-screen pb-20">
            <div className="w-full p-5 bg-[#A79684]">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-5">
                        <h1 className="text-2xl">Turkum</h1>
                        <button onClick={() => setCreateModal(true)} className="bg-white text-lg px-5 py-2 rounded-md border-2 border-white duration-500 hover:bg-transparent hover:text-white">
                            Yaratish
                        </button>
                    </div>
                </div>
            ...
            {data && data?.length > 0 ? (
                <div className="p-6">
                    <table className="min-w-full table-auto">
                        <thead className="bg-[#A79684] text-[white]">
                            <tr>
                        ...
                        <button
                            className={`py-2 px-4 rounded-md ${currentPage === 1
                                ...
                                : 'bg-[#A79684] text-white hover:bg-[#8d715c]'
                                }`}
