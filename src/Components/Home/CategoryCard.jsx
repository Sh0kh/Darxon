        ...
        <div className="Category__Wrapper mt-[50px]">
            {categoryData?.map((i, index) => (
                <NavLink to={`/category/${i?.id}`}>
                    <div key={index} className="Category__Card h-[310px]  relative border-[4px] border-[#A79684] rounded-[30px] bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${CONFIG.API_URL + i?.image})` }} >
