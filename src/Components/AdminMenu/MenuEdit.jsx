...
const MenuEdit = ({ isOpen, onClose, refresh, data }) => {
    ...
    const customStyles = {
        ...
        option: (provided, state) => ({
            ...provided,
            backgroundColor: state.isSelected ? '#A79684' : state.isFocused ? 'white' : 'white', // Черный фон для option
            color: 'black', // Белый текст в option
            '&:hover': {
                backgroundColor: '#A79684', // Темнее фон при hover
            },
        }),
        menu: (provided) => ({
            ...provided,
            ...
            <div onClick={(e) => e.stopPropagation()} className={`Modal2Content ${isOpen ? "open" : ""} overflow-y-auto`}>
                <div className="p-6 pb-12 bg-white rounded-lg mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <label
                                    htmlFor="photo-input"
                                    className="w-full p-3 mt-2 border border-gray-300 rounded-lg cursor-pointer bg-[#A79684] text-white focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center justify-between"
                                >
                    ...
                    <div className="mt-6 flex justify-end space-x-4">
                        <button
                            onClick={CreateMenu}
                            className="px-6 py-2 bg-[#A79684] duration-500 text-white rounded-lg hover:bg-[#766a5b]"
                        >
                            Saqlash
                        </button>
                    </div>
