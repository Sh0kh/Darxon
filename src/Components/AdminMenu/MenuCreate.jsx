            ...
            <div onClick={(e) => e.stopPropagation()} className={`Modal2Content ${isOpen ? "open" : ""} overflow-y-auto`}>
                <div className="p-6 pb-12 bg-white rounded-lg mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <input
                                ...
                                className="w-full p-3 mt-2 border border-gray-300 rounded-lg cursor-pointer bg-[#A79684] text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                        </div>
                    </div>
                    ...
                    <div className="mt-6 flex justify-end space-x-4">
                        <button
                            onClick={CreateMenu}
                            className="px-6 py-2 bg-[#A79684] duration-500 text-white rounded-lg hover:bg-[#766a5e] focus:outline-none"
                        >
                            Yaratish
                        </button>
                    </div>
